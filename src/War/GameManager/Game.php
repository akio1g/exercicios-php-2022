    ...
    protected function playRound(): void
    {
        foreach ($this->getUnconqueredCountries() as $attackingCountry) {
            ...
            if ($attackingCountry instanceof ComputerPlayerCountry) {
                ...
                do {
                    $typedName = readline("Digite o nome de um pa�s para atacar ou deixe em branco para n�o atacar ningu�m:\n");
        ...
        foreach ($this->getUnconqueredCountries() as $i) {
            $i->setNumberofTroops(3);
        }
    }
